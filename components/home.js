...
const Home = () => {
    return (
        <section className={utilStyles.headingMd}>
            <h1>About Me</h1>
            <p style={{ fontSize: "18px" }}>Hi, I’m Kailash, a third-year undergraduate computer science student at the National University of Singapore, expecting to graduate by May 2026. While I am interested in all things computer science, my primary focus areas are <b>back-end development</b> and <b>development in C++</b>. I am also extremely passionate about <b>operating systems</b> and <b>parallel computing</b>, which are my areas of focus at NUS.
